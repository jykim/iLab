...
def set_collection_param(col_id)
  ...
  when 'trec'
    ...
    $prmd_lambda = 0.7
    $bfs = [0.146, 0.236, 0.146, 0.0, 0.382, 0.133] #[0.0, 0.549, 0.0, 0.0, 0.188, 0.0]#[0.0, 0.541019645878629, 0.0, 0.0, 0.291796053982211, 0.0]
  ...
  when 'imdb'
    ...
    $bfs = [0.0, 61.803, 100.0, 0.0, 0.0, 4.257, 100.0, 100.0, 49.342, 100.0]

...
$o = {:verbose=>true, :topic_id=>'cv31', :new_topic_id=>'MEM1115', :no_cand=>3, :smooth_ratio=>0.5}; $method='memory'; $col='trec'; $exp='gen_query'; $remark='1115'; eval IO.read('run_prms.rb')
